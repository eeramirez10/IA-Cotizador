...
twilio_client.register_phone_agent(os.getenv("+14123854580"), os.getenv('RETELL_AGENT_ID'))
...
async def handle_twilio_voice_webhook(request: Request):
    ...
    call = twilio_client.create_phone_call(os.getenv("+14123854580"), to_number, os.environ['RETELL_AGENT_ID'], custom_variables)#from,to
